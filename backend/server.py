...
# async def handle_client(websocket) :   # represents one WebSocket connection, not one call.
...
# Agent:
# http://localhost:5500/index.html?role=agent

# Customer:
# http://localhost:5500/index.html?role=customer
...
async def main():
    ...
    async with websockets.serve(
        ...
        print(
            f"Signaling server running on port {PORT}"
        )
